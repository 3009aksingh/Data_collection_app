...
router.post("/discussion1st", async (req, res) => {
  //   changed /index to whatever
  try {
...
router.post("/discussion3rd", async (req, res) => {
  //for response POST request
    ...
    User.findOne({
      ...
      if (user) {
        ...
        bcrypt.genSalt(10, (err, salt) => {
          //for encrypting the users typed
